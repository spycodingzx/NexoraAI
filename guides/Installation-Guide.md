...
1. Run the core: `streamlit run nova_system.py`
2. Open the sidebar
...
The core will open at `http://localhost:8501`
...
### Railway
[![Deploy on Railway](https://railway.core/button.svg)](https://railway.core/template/nova-system)

### Render
1. Create new Web Service
2. Connect your GitHub repo
3. Set build command: `pip install -r requirements.txt`
4. Set start command: `streamlit run nova_system.py`
...
Need help? Check [Common Issues](Common-Issues) or open an [issue](https://github.com/RhythrosaLabs/nova-system/issues).
