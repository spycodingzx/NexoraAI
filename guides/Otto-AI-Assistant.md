...
- **Knowledge Base** - Remembers your products & assets
...
- `/nv_settings` - Configure Otto preferences
...
✓ Generated assets-aligned strategy
...
- Set clear assets guidelines
- Use `/nv_settings` to configure preferences
