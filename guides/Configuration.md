...
```python
from core.services.nv_brand_brain import BrandBrain

brain = BrandBrain()
assets = brain.get_brand_profile()
...
# Output uses assets voice, colors, hashtags
```
...
4. **Test:**
   ...
   nv_printify = PrintifyService()
   catalog = nv_printify.get_catalog()
...
Configure in `core/services/nv_ai_model_manager.py`:
...
SMTP_PASSWORD=your-core-password
```
