...
from core.core.nv_exceptions import (
    AppError,
    APIError,
    ValidationError,
    ConfigurationError,
...
class TestValidateInput:
    """Test input nv_validation function"""

    def test_type_validation(self):
        """Test type nv_validation."""
    ...
    def test_min_value_validation(self):
        """Test minimum value nv_validation."""
    ...
    def test_max_value_validation(self):
        """Test maximum value nv_validation."""
    ...
    def test_allowed_values_validation(self):
        """Test allowed values nv_validation."""
