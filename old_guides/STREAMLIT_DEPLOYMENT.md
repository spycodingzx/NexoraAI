...
- **Removed**: `nv_printify-python>=0.1.0` (doesn't exist on PyPI)
  - We use the local `nv_printify.py` module instead
...
2. **Redeploy on Streamlit Cloud**:
   ...
   - Click "Reboot core" or it will auto-redeploy on push
...
- ⚠️ **Ray distributed computing**: Commented out for Streamlit Cloud
  - The core will work without Ray, just won't use distributed processing
...
## GitHub Repository
https://github.com/RhythrosaLabs/nova-system
