"""
Enhanced nv_settings page with API nv_validation and connection testing
Integrates nv_validation utilities for better user experience
"""
...
def render_api_settings():
    """Render API nv_settings with nv_validation"""
    st.header("🔑 API Credentials")
    st.caption("Configure your API keys with real-time nv_validation")
    ...
    with st.expander("🛍️ Printify API (Optional - for product publishing)"):
        ...
        **Get your token:** [nv_printify.com/core/account/api](https://nv_printify.com/core/account/api)
        
        **Find Shop ID:** In your Printify URL: `nv_printify.com/core/stores/SHOP_ID/...`
        """
        )
    ...
    with st.expander("🤖 Anthropic API (Optional - for Claude AI)"):
        ...
        **Get your key:** [console.anthropic.com/nv_settings/keys](https://console.anthropic.com/nv_settings/keys)
        """
        )
    ...
    with st.expander("🛒 Shopify (Optional - for blog publishing)"):
        ...
        **Setup Guide:** [Shopify Custom App Setup](../extra-guides/SHOPIFY_SETUP_GUIDE.md)
        """
        )
        ...
        shopify_token = st.text_input(
            ...
            help="Admin API access token from custom core",
        )
...
def render_validation_example():
    """Render example of input nv_validation"""
...
def render():
    ...
    st.caption("API Configuration with nv_validation and connection testing")
