...
async def execute_shortcut_in_background(task_id, shortcut):
    ...
    try:
        ...
        from core.services.nv_background_tasks import BackgroundTaskManager
        ...
        for step_idx, step in enumerate(shortcut["steps"]):
            ...
            try:
                if step["type"] == "generate":
                    ...
                    from core.services.nv_chat_assistant import ChatAssistant

                    nv_chat_assistant = ChatAssistant()

                    ai_response = await nv_chat_assistant.process_message(prompt, [])
                            ...
                            if run_clicked:
                                ...
                                if bg_option:
                                    ...
                                    try:
                                        ...
                                        from core.services.nv_background_task_manager import (
                                ...
                                if not bg_option:
                                    ...
                                    try:
                                        ...
                                        # Create grid nv_layout for step progress (max 3 columns)
                                            ...
                                            with step_cols[col_idx]:
                                                ...
                                                if step["type"] == "generate":
                                                    ...
                                                    try:
                                                        ...
                                                        if "nv_chat_assistant" not in st.session_state:
                                                            from core.services.nv_chat_assistant import (
                                                                ChatAssistant,
                                                            )

                                                            st.session_state.nv_chat_assistant = (
                                                                ChatAssistant()
                                                            )
                                                        ...
                                                        ai_response = asyncio.run(
                                                            nv_chat_assistant.process_message(
                                                                prompt, []
                                                            )
                                                        )
                                        ...
                                        # Store results
                                        if shortcut["nv_settings"].get("log"):
                                        ...
                                        if shortcut["nv_settings"].get("notify"):
                                            st.balloons()
