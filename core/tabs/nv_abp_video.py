...
def render_video_producer_tab():
    ...
    with st.expander("🛍️ Product Settings", expanded=True):
        ...
        with col1:
            ...
            brand_name = st.text_input(
                ...
                help="Your assets name for consistency",
            )
        with col2:
    ...
    # Map video model selection to flags (needed for advanced nv_settings)
    use_ken_burns = "Ken Burns" in video_model_option
            ...
            for i, segment in enumerate(script_segments):
                ...
                try:
                    ...
                    if use_luma:
                        ...
                        # Use generate_ken_burns_video from plugins (returns bool)
                        ...
                        if auto_publish_youtube:
                            ...
                            try:
                                ...
                                if not yt_service.authenticate():
                                    ...
                                    st.info(
                                        "💡 Run `python nv_setup_youtube.py` to authenticate YouTube API"
                                    )
                                else:
