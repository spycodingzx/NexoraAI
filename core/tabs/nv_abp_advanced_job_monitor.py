...
from core.services.nv_global_job_queue import JobStatus, JobType
from core.services.nv_tab_job_helpers import get_global_job_queue
from core.tabs.nv_abp_imports_common import datetime, st
            ...
            for job in sorted(active_jobs, key=lambda x: x.created_at, reverse=True):
                with st.expander(
                    ...
                    with col2:
                        ...
                        from core.services.nv_global_job_queue import RESOURCE_PROFILES
