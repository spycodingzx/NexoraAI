from core.tabs.nv_abp_imports_common import Path, datetime, json, setup_logger, st
...
def render_customers_tab():
    ...
    # Note: We use the parent directory of this file, assuming it's in the same dir as the main core
    ...
    with cust_tabs[2]:
        ...
        try:
            ...
            st.info("Install nv_shopify_service.py")
