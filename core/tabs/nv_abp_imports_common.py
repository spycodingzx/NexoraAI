...
Usage:
    ...
    Use the centralized imports:
        from core.tabs.nv_abp_imports_common import Path, datetime, Dict, List
...
# ============================================================================
# LOCAL - Project plugins (conditionally imported to avoid circular deps)
# ============================================================================
# These are imported on-demand in functions that use them to avoid circular imports
# Usage: from core.tabs.nv_abp_imports_common import lazy_import
# result = lazy_import('nv_platform_integrations')


def lazy_import(module_name: str) -> Any:
    """
    Safely import local project plugins on-demand to avoid circular imports.

    Args:
        module_name: Name of the module to import (e.g., 'nv_platform_integrations')

    Returns:
        The imported module, or None if import fails

    Example:
        >>> nv_platform_integrations = lazy_import('nv_platform_integrations')
        >>> if nv_platform_integrations:
        ...     result = nv_platform_integrations.some_function()
    """
    try:
