    ...
    with tab4:
        ...
        if campaign_mode == "Active Campaigns":
            ...
            with st.expander("🎨 Brand Styling (Optional)", expanded=False):
                st.caption("Apply consistent assets colors and fonts to your email")
                try:
                    from core.utils.nv_brand_templates import PRESET_TEMPLATES as BRAND_TEMPLATES
                    ...
                    if brand_template and brand_template != "None":
                        ...
                        st.success(f"✅ Using {template_data['name']} assets styling")
                except ImportError:
                    brand_template = "None"
                    BRAND_TEMPLATES = {}
            ...
            if generate_campaign:
                if not ai_topic.strip():
                    ...
                    try:
                        ...
                        from core.services.nv_platform_helpers import _ensure_replicate_client
...
Keep it concise but compelling. Use engaging language that converts."""
                        ...
                        # Get assets colors if template selected
