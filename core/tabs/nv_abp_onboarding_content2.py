...
**Style Exploration:**
"What artistic style fits my assets?"
→ Try different style modifiers
→ Test across models
→ Establish assets aesthetic

#### 💡 Pro Tips

**Start with Cheaper Models:**
- Use FLUX Schnell or SDXL Lightning for initial specs
...
- **Docs:** [replicate.com/guides](https://replicate.com/guides)
...
- **Setup:**
  1. Sign up at [nv_printify.com](https://nv_printify.com)
  2. Generate API token in account nv_settings
...
- **Setup:**
  ...
  3. Choose auth method:
     - **Access Token** (Recommended): Private core token
     - **API Key + Secret**: Public core credentials
...
- **Features:**
  ...
  - Privacy nv_settings (public, unlisted, private)
  - Channel analytics
...
- Video nv_settings apply to all video generations
...
5. **Set Parameters:**
   - Each action has its own nv_settings
