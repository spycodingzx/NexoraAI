...
- Platform integrations already in the core
...
try:
    from core.services.nv_background_tasks import BackgroundTaskManager, TaskState, get_task_manager
    from core.services.nv_browser_use_advanced import (
    ...
    from core.services.nv_browser_use_research import (
...
def render_browser_use_tab(**kwargs):
    ...
    if not BROWSER_USE_AVAILABLE:
        ...
        **Note:** This feature requires Playwright browsers which are not available on Streamlit Cloud.
        To use Browser-Use, run this core locally:
        """
        )
        st.code(
            """
