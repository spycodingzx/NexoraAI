...
from core.tabs.nv_abp_imports_common import Path, datetime, os, setup_logger, st
...
try:
    from core.utils.nv_error_recovery import PartialSuccessHandler, batch_process_with_recovery
...
Format: Just the 5 headlines, numbered."""
    ...
    if st.session_state.get("campaign_generation_jobs"):
        ...
        if are_all_jobs_done(job_ids):
            ...
            # Create generator to compile final guides
            try:
