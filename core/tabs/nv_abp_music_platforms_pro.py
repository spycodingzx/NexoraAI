...
try:
    from core.utils.nv_music_platform_oauth import (
        OAUTH_CONFIGS,
        AppleMusicAPIClient,
        CredentialStorage,
        DeezerAPIClient,
...
def render_bandcamp_tab():
    ...
    with tabs[0]:
        ...
        if st.button("💾 Save Store Settings"):
            st.success("Store nv_settings updated!")
...
def render_music_platforms_tab():
    ...
    # Main content area with nv_settings
            ...
            if st.button("💾 Save Spotify Credentials", use_container_width=True):
                if spotify_client_id and spotify_client_secret:
                    ...
                    try:
                        ...
                        st.info("🔄 Restarting core to load credentials...")
        ...
        if st.session_state.active_music_platform:
            ...
            if platform_key in oauth_platforms:
                ...
                try:
                    ...
                    st.info(
                        f"Click the button below to open {platform_info['name']} and authorize this core. "
                    ...
                    with col1:
                        if st.button(
                            ...
                            st.markdown(
                                "*This will open in a new window. Authorize the core, then return here.*"
                            )
