...
from core.core.nv_container import setup_dependencies
from core.core.nv_exceptions import ErrorContext, handle_errors
from core.core.nv_session_init import initialize_session_state
from core.core.nv_tab_loader import get_tab_renderer
...
def configure_environment() -> None:
    ...
    sys.path.insert(0, str(base_dir / "core" / "tabs"))
    sys.path.insert(0, str(base_dir / "core" / "services"))
    sys.path.insert(0, str(base_dir / "core" / "utils"))
...
def configure_streamlit() -> None:
    """Configure Streamlit page nv_settings."""
    st.set_page_config(
...
def initialize_app() -> None:
    ...
    This should be called once at the start of the core.
    """
...
def create_app() -> None:
    ...
    # Render UI
    from core.ui.nv_layout import render_main_layout
