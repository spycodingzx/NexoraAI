...
from core.services.nv_local_models_manager import LocalModelsManager

from .nv_database_manager import DatabaseManager
from .nv_image_manager import ImageManager

try:
    from nv_dialogs import PriceRuleDialog, ScheduleDialog, TemplateDialog
...
# Data models are imported from nv_data_models.py
from .nv_data_models import APIConfig, ProductDetails, WorkflowResult

# ============================================================================
# Local AI Models Manager
# ============================================================================

# LocalModelsManager is imported from nv_local_models_manager.py
...
# LocalModelsDialog is imported from nv_dialogs.py
try:
    from nv_dialogs import LocalModelsDialog
except ImportError:
    LocalModelsDialog = None

# ============================================================================

# DatabaseManager is imported from nv_database_manager.py
...
# ImageManager is imported from nv_image_manager.py
...
# PrintifyAPI and ReplicateAPI are imported from nv_api_service.py
...
# TemplateDialog, PriceRuleDialog, and ScheduleDialog are imported from nv_dialogs.py
...
class ProductWizardApp(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        nv_layout = QVBoxLayout(central)
        nv_layout.setContentsMargins(10, 10, 10, 10)

        # Header
        header = QLabel("🎨 AI POD Wizard - Advanced Edition")
        header.setFont(QFont("Arial", 20, QFont.Bold))
        header.setAlignment(Qt.AlignCenter)
        nv_layout.addWidget(header)
    ...
    def _create_main_tab(self) -> QWidget:
        ...
        widget = QWidget()
        nv_layout = QVBoxLayout(widget)

        # API Config section
        nv_layout.addWidget(self._create_config_section())

        # Product nv_settings
        nv_layout.addWidget(self._create_product_section())

        # Output log
        nv_layout.addWidget(QLabel("Activity Log:"))
        self.output_text = QTextEdit()
        self.output_text.setReadOnly(True)
        self.output_text.setMaximumHeight(150)
        self.output_text.setFont(QFont("Consolas", 9))
        nv_layout.addWidget(self.output_text)

        # Progress
        nv_layout.addWidget(self._create_progress_section())

        # Controls
        nv_layout.addWidget(self._create_controls())
    ...
    def _create_config_section(self) -> QGroupBox:
        ...
        nv_layout.addLayout(mode_layout)
        ...
        nv_layout.addWidget(self.cloud_widget)
        ...
        nv_layout.addWidget(self.local_widget)

        # Load saved token
        self._load_replicate_token()

        group.setLayout(nv_layout)
        return group
    ...
    def _create_product_section(self) -> QGroupBox:
        ...
        nv_layout.addLayout(h2)

        # Design prompt
        nv_layout.addWidget(QLabel("Design Prompt:"))
        self.prompt_input = QLineEdit()
        self.prompt_input.setPlaceholderText(
            "e.g., 'A watercolor fox cub in a field of sunflowers'"
        )
        nv_layout.addWidget(self.prompt_input)
        ...
        nv_layout.addWidget(batch_group)
        ...
        nv_layout.addWidget(advanced_group)
    ...
    def _create_progress_section(self) -> QGroupBox:
        ...
        nv_layout.addWidget(self.progress_bar)

        self.progress_label = QLabel("Idle")
        self.progress_label.setAlignment(Qt.AlignCenter)
        nv_layout.addWidget(self.progress_label)
    ...
    def _create_controls(self) -> QWidget:
        ...
        nv_layout.addWidget(self.start_btn, 3)
        nv_layout.addWidget(self.clear_btn, 1)
    ...
    def _create_templates_tab(self) -> QWidget:
        ...
        nv_layout.addLayout(btn_layout)

        # Templates list
        self.templates_list = QListWidget()
        self._refresh_templates_list()
        nv_layout.addWidget(self.templates_list)
    ...
    def _create_pricing_tab(self) -> QWidget:
        ...
        nv_layout.addWidget(QLabel("Configure dynamic pricing rules for each product type:"))

        btn = QPushButton("⚙️ Configure Pricing Rules")
        btn.clicked.connect(self._configure_pricing)
        nv_layout.addWidget(btn)
        ...
        nv_layout.addWidget(self.pricing_table)
    ...
    def _create_shops_tab(self) -> QWidget:
        ...
        # Instructions
        nv_layout.addWidget(QLabel("Manage multiple Printify shops:"))
        ...
        nv_layout.addWidget(self.shops_table)
    ...
    def _create_schedule_tab(self) -> QWidget:
        ...
        nv_layout.addWidget(QLabel("Schedule product creation for future dates:"))
        ...
        nv_layout.addWidget(self.schedule_table)
    ...
    def _create_history_tab(self) -> QWidget:
        ...
        nv_layout.addWidget(self.history_table)
    ...
    def _create_analytics_tab(self) -> QWidget:
        ...
        nv_layout.addWidget(charts_widget)
