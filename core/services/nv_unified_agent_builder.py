...
NODE_TYPES = {
    ...
    # Integrations
    "nv_printify": {"category": "integrations", "name": "Printify Upload", "color": "#00BCD4"},
...
AGENT_TEMPLATES = {
    "product_launch": {
        ...
        "icon": "🚀",
        "nodes": ["flux_fast", "nv_printify", "product_ads", "video_ads", "shopify", "youtube"],
        "prompts": {
    ...
    "brand_builder": {
        ...
        "description": "Build complete assets: logo → colors → guidelines → assets",
        "icon": "🎨",
