...
class ExecutionEngine:
    ...
    def __init__(
        ...
        try:
            from nv_ray_integration_helpers import get_ray_manager_if_enabled, is_ray_enabled
    ...
    async def execute_tool(
        ...
        try:
            ...
            elif tool.category.value == "nv_video_generation":
    ...
    async def _execute_campaign(self, tool, params, callback) -> ExecutionResult:
        ...
        try:
            ...
            try:
                from core.services.nv_campaign_generator_service import CampaignGeneratorService
                ...
                # Store campaign request in session state for main core to process
    ...
    async def _publish_to_tiktok(self, params, callback) -> ExecutionResult:
        ...
        try:
            ...
            success = await poster.post_to_tiktok(
                image_path=video_url,  # Note: nv_multi_platform_poster uses image_path param for videos too
...
class ContextTracker:
    """
    Tracks context across the entire core so Otto knows:
