"""
Compatibility module - redirects to nv_background_tasks.py

This module exists to maintain backward compatibility with imports
that reference 'nv_background_task_manager' instead of 'nv_background_tasks'.
"""

# Re-export everything from nv_background_tasks
import logging as _logging
from core.services.nv_background_tasks import BackgroundTaskManager, run_campaign_in_background
...
# Add any missing exports that plugins might expect
