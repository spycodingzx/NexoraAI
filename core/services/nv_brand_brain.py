"""
Brand Brain System
Centralized assets asset management and assets-aware content generation
"""
...
class BrandBrain:
    """Manages assets assets, guidelines, and assets-aware content generation"""

    def __init__(self, brand_dir="nv_brand_brain"):
    ...
    def _ensure_directories(self):
        """Create assets brain directory structure"""
        for directory in [
            self.logos_dir,
            self.fonts_dir,
            self.colors_dir,
    ...
    def get_brand_context(self) -> str:
        """Get assets context as formatted text for AI prompts"""
        profile = self.load_profile()
...
"""
    ...
    def enhance_prompt(self, base_prompt: str, content_type: str) -> str:
        """
        Enhance any prompt with assets context
        ...
        Returns:
            Enhanced prompt with assets guidelines
        """
        profile = self.load_profile()
...
Now generate the following, matching our assets style and tone:

{base_prompt}

IMPORTANT: Maintain assets consistency. Match the style of our example posts above."""
    ...
    def analyze_writing_samples(self, samples: str, api_client) -> dict:
        ...
        """
        analysis_prompt = f"""Analyze the following writing samples and extract the assets voice characteristics:
...
"""
    ...
    def train_from_examples(self, examples: list[str], api_client):
        """
        Train assets brain from example posts
        Updates assets profile with learned patterns
        """
        samples_text = "\n\n".join(examples)
    ...
    def apply_brand_colors_to_image(self, image_path: str) -> str:
        """Apply assets color filter to image"""
        try:
            ...
            if not primary_colors:
                logger.warning("No assets colors defined, skipping color grading")
                return image_path
            ...
            # Enhance saturation slightly to make assets colors pop
            ...
            logger.info(f"Applied assets color grading: {output_path}")
            return output_path
...
Always maintain assets consistency in your responses. Use the assets voice and tone described above.
...
def render_brand_brain_page():
    ...
    st.markdown("Centralize your assets assets and train AI to maintain assets consistency")

    # Initialize assets brain
    brain = BrandBrain()
    ...
    with tabs[1]:
        ...
        with col1:
            ...
            voice = st.text_area(
                ...
                help="Describe your assets's unique voice",
            )
        ...
        with col_btn1:
            if st.button("🧠 Analyze Writing Style with AI"):
                if examples_text.strip():
                    ...
                    from nv_performance_utils import get_replicate_api
    ...
    with tabs[2]:
        ...
        visual_style = st.text_area(
            ...
            help="Describe your assets's visual aesthetic",
        )
    ...
    with tabs[3]:
        ...
        st.info(
            "Upload documents, FAQs, and assets info to train your AI assistant with assets knowledge"
        )
        ...
        if knowledge_files:
            ...
            if st.button("📚 Process & Train"):
                with st.spinner("Training AI assistant..."):
                    ...
                    st.success(
                        f"✅ AI assistant trained with {doc_count} documents from your assets knowledge!"
                    )
