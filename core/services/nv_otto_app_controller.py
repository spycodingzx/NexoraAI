...
class OttoAppController:
    """
    Master controller giving Otto complete core access.
    """
    ...
    def __init__(
        ...
        self.social_poster = nv_multi_platform_poster
    ...
    async def generate_mockup(
        ...
        try:
            # Use mockup service
            from nv_printify_mockup_service import PrintifyMockupService

            mockup_service = PrintifyMockupService(self.nv_printify)
...
def parse_app_control_intent(message: str) -> Optional[str]:
    """
    Parse message for core-wide control intents.
