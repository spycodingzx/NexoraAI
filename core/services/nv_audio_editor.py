...
class AudioEditor:
    ...
    def __init__(self, nv_api_service=None, output_dir: Optional[Path] = None):
        self.nv_api_service = nv_api_service
        self.output_dir = output_dir or Path(tempfile.gettempdir()) / "nv_audio_editor"
...
def render_audio_editor_ui():
    ...
    editor = AudioEditor(nv_api_service=api)
