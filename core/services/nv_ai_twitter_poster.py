...
class AITwitterPoster:
    ...
    - Post to Twitter manually through web browser or mobile core
...
def main():
    ...
    if len(sys.argv) < 3:
        print(
            "Usage: python nv_ai_twitter_poster.py <image_path> <caption> [--headless] [--browser=chrome|brave|firefox]"
        )
        print("\nExample:")
        print(
            '  python nv_ai_twitter_poster.py /path/to/image.png "Check out this awesome design!" --browser=brave'
        )
