...
Integrates with Shopify Digital Downloads core for automated delivery.
"""
...
DIGITAL_PRODUCT_TYPES = {
    ...
    "software": {
        "name": "Software",
        "icon": "💻",
        "extensions": [".zip", ".exe", ".dmg", ".core", ".msi", ".deb", ".rpm"],
        "max_size_mb": 2000,
...
"""
    ...
    def create_digital_product(
        ...
        try:
            ...
            if response and "product" in response:
                ...
                # Store file reference for Digital Downloads core
    ...
    def _store_digital_file_reference(self, product_id: int, file_path: str, file_info: Dict):
        ...
        Note: The actual Digital Downloads core integration requires
        ...
        **kwargs,
        ...
        try:
            ...
            if product_type == "ebook":
                from .nv_digital_product_generator import EBookGenerator
                ...
                from .nv_digital_product_generator import ColoringBookGenerator
                ...
                from .nv_digital_product_generator import CourseGenerator
...
# Convenience functions for the main core
def create_digital_product(
    file_path: str,
    title: str,
    price: float,
...
if __name__ == "__main__":
    ...
    # Test file detection
    service = DigitalProductsService()
    test_files = ["song.mp3", "core.zip", "design.psd", "book.pdf"]
