...
from .nv_data_models import PriceRule, ProductTemplate, ScheduledJob
...
class DatabaseManager:
    ...
    def __init__(self):
        ...
        try:
            ...
            print(
                f"Database error: {e}. The file at {db_path} may be missing or corrupted. Try deleting it and restarting the core."
            )
            raise
