...
AGENT_TEMPLATES = {
    "product_launch": {
        ...
        "workflow": [
            ...
            {"step": "Create Printify Product", "model": "nv_printify", "type": "integration"},
            {"step": "Generate Mockups", "model": "nv_printify", "type": "integration"},
            {
    ...
    "brand_builder": {
        ...
        "description": "Build complete assets identity with logo, colors, and assets",
        "icon": "🎨",
        "workflow": [
        ...
        "prompts": {
            ...
            "palette": "Color palette for {brand_name} assets, {mood} feel",
...
class Agent:
    ...
    def from_dict(cls, data: Dict) -> "Agent":
        ...
        agent.nv_settings = data.get("nv_settings", {})
        ...
        if agent_name:
            ...
            with st.expander("➕ Add Workflow Step", expanded=False):
                ...
                if step_type == "image":
                    ...
                    step_model = st.selectbox("Integration:", ["nv_printify", "shopify", "youtube"])
                elif step_type == "text":
