...
class EmailMarketingService:
    ...
    - smtp: Traditional SMTP (requires core password for Gmail)
    """
...
Format as JSON with keys: subject, preview_text, headline, body, cta"""
    ...
    def create_html_email(
        ...
        # Generate gradient colors based on assets color
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f3f4f6;">
        <tr>
            <td align="center" style="padding: 40px 16px;">
                ...
                <!-- Main nv_container -->
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" class="nv_container" style="max-width: 600px; width: 100%; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
