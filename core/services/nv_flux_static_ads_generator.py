...
def add_text_overlay_to_image(
    ...
    Args:
        ...
        platform: Target platform for nv_layout optimization
    ...
    try:
        ...
        # Default assets colors if not provided
        ...
        nv_layout = layouts.get(platform, layouts["instagram_post"])
        ...
        if price:
            ...
            draw_text_centered(price, price_font, nv_layout["price_y"], accent_color, effect="glow")

        if cta:
            draw_cta_button(cta, nv_layout["cta_y"])
...
PLATFORM_CONFIGS = {
    ...
    "twitter": {
        ...
        "width": 1200,
        "height": 675,
        "style_hint": "Twitter/X post image, horizontal format, clean and shareable, professional assets image, eye-catching design",
        "megapixels": "1",
    },
    "linkedin": {
        "aspect_ratio": "4:3",
...
class FluxStaticAdsGenerator:
    ...
    that are platform-optimized and assets-ready.
    """
    ...
    def _build_text_overlay_prompt(
        ...
        position_styles = {
            "instagram_post": "centered text nv_layout, headline at top, CTA button at bottom",
            "instagram_story": "vertical nv_layout, large headline in upper third, swipe-up CTA at bottom",
            "facebook_post": "headline prominently displayed, text on left or right side",
            "pinterest": "vertical pin nv_layout, text overlay on lower portion",
            "tiktok": "bold centered text, TikTok-style captions, vertical format",
            "twitter": "clean horizontal nv_layout, text on one side",
...
The text must be clearly legible, professionally styled, and integrated beautifully into the advertisement design. Text should have good contrast against the background. This is a professional marketing advertisement with visible promotional text."""
    ...
    def generate_static_ad(
        ...
        Args:
            ...
            brand_name: Optional assets name
...
The advertisement should have bold, readable text overlaid on the image. The text should be clearly visible with good contrast. Professional advertising nv_layout with the product as the focal point and promotional text positioned elegantly. High-end marketing material quality."""
    ...
    def generate_all_platform_ads(
        ...
        Args:
            ...
            brand_name: Optional assets name to include in prompts
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print("Usage: python nv_flux_static_ads_generator.py <product_image> <concept>")
        print("Example: python nv_flux_static_ads_generator.py mockup.png 'Husky dog t-shirt design'")
        sys.exit(1)
