...
class DocumentEditor:
    ...
    def generate_document(self, prompt: str, document_type: str, nv_api_service=None) -> str:
        """Generate document content using AI."""
        if nv_api_service is None:
...
Write the complete document now:"""
        ...
        content = nv_api_service.generate_text(full_prompt, max_tokens=2000)
        return content
