...
Eliminates code duplication by using plugins/nv_ai_generation.py, plugins/nv_audio_processing.py, and plugins/nv_file_utils.py
"""
...
from plugins import (  # AI Generation; Audio Processing; File Utilities
    download_file,
...
# Ad tone to voice mapping (uses VOICE_MAP from plugins)
AD_TONE_VOICE_MAP = {
...
# Ad tone to music style mapping (maps to MUSIC_PROMPTS from plugins)
AD_TONE_MUSIC_MAP = {
...
Write ONLY the script - no extra commentary."""
    ...
    def generate_background_music(
        ...
        REFACTORED: Now uses generate_background_music() from plugins/nv_ai_generation.py
