...
Handles the main application nv_layout and navigation.
...
from core.core.nv_exceptions import handle_errors
from core.core.nv_tab_loader import get_available_tabs, get_tab_renderer
...
def render_main_layout() -> None:
    """
    Render the main application nv_layout with navigation.
    """
    # Render header
    render_header()
...
def render_footer() -> None:
    ...
    with col3:
        from core.core.nv_session_init import get_session_info
