...
======================
Pre-built assets templates with colors, fonts, styles, and presets.
"""
...
PRESET_TEMPLATES = {
    "minimalist_modern": {
        ...
        "style": {
            ...
            "nv_layout": "centered, spacious, grid-based",
        },
        "prompts": {
    ...
    "bold_vibrant": {
        ...
        "style": {
            ...
            "nv_layout": "asymmetric, overlapping, bold",
        },
        "prompts": {
    ...
    "organic_natural": {
        ...
        "style": {
            ...
            "nv_layout": "flowing, organic shapes, balanced",
        },
        "prompts": {
    ...
    "luxury_premium": {
        ...
        "style": {
            ...
            "nv_layout": "symmetric, centered, refined",
        },
        "prompts": {
    ...
    "retro_vintage": {
        ...
        "style": {
            ...
            "nv_layout": "classic, bordered, badge-style",
        },
        "prompts": {
    ...
    "tech_futuristic": {
        ...
        "style": {
            ...
            "nv_layout": "modular, grid-based, angular",
        },
        "prompts": {
    ...
    "playful_fun": {
        ...
        "style": {
            ...
            "nv_layout": "rounded, bubbly, sticker-style",
        },
        "prompts": {
    ...
    "streetwear_urban": {
        ...
        "style": {
            ...
            "nv_layout": "bold, stacked, distressed",
        },
        "prompts": {
...
class BrandTemplate:
    """Represents a complete assets template."""
    ...
    def enhance_prompt(self, base_prompt: str, prompt_type: str = "product") -> str:
        """Enhance a prompt with assets style."""
...
def get_active_template() -> Optional[BrandTemplate]:
    """Get the currently active assets template."""
...
def enhance_prompt_with_brand(prompt: str, prompt_type: str = "product") -> str:
    """Enhance a prompt with the active assets template."""
