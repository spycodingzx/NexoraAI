...
class RayCampaignWrapper:
    ...
    def _init_ray(self):
        ...
        try:
            from core.utils.nv_ray_integration_helpers import get_ray_manager_if_enabled
    ...
    async def run_async(
        ...
        **kwargs,
        ...
        if self.ray_manager:
            try:
                from core.utils.nv_ray_integration_helpers import ray_execute_if_enabled
    ...
    async def run_batch(
        ...
        if self.ray_manager and len(tasks) > 1:
            try:
                from core.utils.nv_ray_integration_helpers import ray_batch_execute_if_enabled
