...
# Platform-specific video nv_settings
PLATFORM_PRESETS = {
    "youtube": {
        "name": "YouTube",
        "aspect_ratio": "16:9",
...
def retry_with_exponential_backoff(
    ...
    Args:
        ...
        nv_exceptions: Tuple of nv_exceptions to catch
...
def convert_video_for_platform(
    ...
    def convert():
        ...
        # Write with platform-specific nv_settings
    ...
    return retry_with_exponential_backoff(convert, max_retries=3, nv_exceptions=(Exception,))
