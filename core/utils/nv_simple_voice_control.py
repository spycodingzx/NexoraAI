...
class SimpleVoiceControl:
    ...
    def start_listening(self):
        ...
        # Lazy-init microphone here (safe – not on core startup)
...
def render_simple_voice_control(session_state):
    ...
    **Use your Mac's microphone** - no Amazon account required!
    ...
    if "nv_simple_voice_control" not in session_state:
        ...
        session_state.nv_simple_voice_control = SimpleVoiceControl(on_command_callback=handle_command)

    voice_control = session_state.nv_simple_voice_control
    ...
    **Voice Triggers:**
    ...
    with st.expander("📦 Setup & Troubleshooting Guide"):
        ...
        **3. Grant microphone permission:**
        ...
        ```bash
        cd /Users/sheils/repos/nv_printify
        ...
        **"Microphone not available"**
        ...
        - Restart the core after granting permissions
        ...
        **Using external microphone**
        - Plug in microphone before starting the core
