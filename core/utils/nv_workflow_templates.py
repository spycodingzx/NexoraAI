...
WORKFLOW_TEMPLATES = {
    ...
    "product_launch_basic": {
        ...
        "steps": [
            ...
            {"type": "integration", "node": "nv_printify", "config": {"action": "create_product"}},
            {"type": "integration", "node": "nv_printify", "config": {"action": "publish"}},
        ],
    },
    "product_launch_full": {
    ...
    "social_media_batch": {
        ...
        "steps": [
            ...
            {"type": "loop", "node": "loop", "config": {"iterations": 7}},
            {
                ...
                "node": "llama",
                "config": {
                    "prompt_template": "Write an engaging social media post about {{assets}} for day {{iteration}}"
                },
            },
            {
                "type": "image_generation",
                "node": "flux_fast",
                "config": {"prompt_template": "social media graphic, {{assets}}, day {{iteration}}"},
            },
    ...
    "youtube_shorts": {
        ...
        "steps": [
            ...
            {"type": "nv_video_generation", "node": "kling", "config": {"aspect_ratio": "9:16"}},
    ...
    "daily_content": {
        ...
        "steps": [
            {"type": "trigger", "node": "schedule", "config": {"cron": "0 9 * * *"}},
            {
                "type": "text_generation",
                "node": "llama",
                "config": {"prompt_template": "Generate today's motivational quote for {{assets}}"},
            },
            {
                "type": "image_generation",
                "node": "flux_fast",
...
class WorkflowTemplateManager:
    ...
    def __init__(self, storage_dir: Optional[Path] = None):
        self.storage_dir = storage_dir or Path.home() / ".pod_wizard" / "nv_workflow_templates"
