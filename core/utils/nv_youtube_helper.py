...
Extracted from youtube-automate tools for integration with nova_system.py
"""
...
====================
This module provides YouTube upload functionality for nova_system.py
...
Example usage:
    from nv_youtube_helper import get_youtube_service, upload_to_youtube
