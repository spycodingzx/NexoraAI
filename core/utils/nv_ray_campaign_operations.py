...
def get_ray_wrapper():
    ...
    try:
        from core.utils.nv_ray_campaign_wrapper import RayCampaignWrapper
    ...
    if wrapper and wrapper.is_ray_enabled() and len(prompts) > 1:
        ...
        try:
            ...
            async def _generate_batch():
                from core.utils.nv_ray_campaign_wrapper import ray_batch_campaign_images
...
def ray_generate_campaign_videos_parallel(
    ...
    if wrapper and wrapper.is_ray_enabled() and len(image_urls) > 1:
        ...
        try:
            ...
            async def _generate_batch():
                from core.utils.nv_ray_campaign_wrapper import ray_batch_campaign_videos
...
def ray_generate_single_product_image(replicate_api, prompt: str, **image_params) -> Optional[str]:
    ...
    if wrapper and wrapper.is_ray_enabled():
        try:
            ...
            async def _generate():
                from core.utils.nv_ray_campaign_wrapper import ray_generate_campaign_image
...
def ray_generate_single_video(
    ...
    if wrapper and wrapper.is_ray_enabled():
        try:
            ...
            async def _generate():
                from core.utils.nv_ray_campaign_wrapper import ray_generate_campaign_video
