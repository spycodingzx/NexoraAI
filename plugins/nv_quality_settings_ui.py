...
UI components for video quality and platform nv_settings
"""
...
def render_quality_settings_ui():
    """
    Render video quality nv_settings interface.

    Returns:
        dict: Quality nv_settings configuration
    """
...
def render_advanced_video_settings():
    """
    Render advanced video nv_settings (Voice, Music, etc).

    Returns:
        dict: Advanced nv_settings configuration
    """
...
def apply_preset_to_quality(quality_config: Dict, preset_settings: Dict):
    """
    Apply preset nv_settings to quality configuration.

    Args:
        quality_config: Current quality nv_settings
