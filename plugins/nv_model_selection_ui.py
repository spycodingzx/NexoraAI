...
# Ensure core/services is importable whether or not configure_environment() has run
_services_path = str(Path(__file__).parent.parent / "core" / "services")
if _services_path not in sys.path:
    sys.path.insert(0, _services_path)

from nv_ai_model_manager import ModelFallbackManager, ModelPriority, VideoModel
